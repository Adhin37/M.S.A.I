...
from image_commons import nparray_as_image, draw_with_alpha, draw_rectangle
...
def show_webcam_and_run(model, emoticons, window_size=None, window_name='webcam', update_time=10):
    ...
    vc = cv2.VideoCapture('IMG_6418.MOV')
    if vc.isOpened():
    ...
    while read_value:
	    ...
	    draw_rectangle(webcam_image,prediction,(x,y,w,h))
