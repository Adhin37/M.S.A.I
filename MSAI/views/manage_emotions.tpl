% rebase('layout.tpl', title=title, year=year, list_emotion=list_emotion, role=role)
                        ...
                        %for l in list_emotion:
                            ...
                            <form class="form-signin" action="/updateEmotion" method="post" enctype="multipart/form-data">
                                <tr id="updateZone{{l[0]}}" style="display:none;">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" id="majEmotion" name="majEmotion" value={{l[1]}} required>
                                    </td>
                                    <td>
